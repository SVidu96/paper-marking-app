...
if(isset($_POST['submit'])){
   ...
   if (!empty($country)) {
      $update_country = $conn->prepare("UPDATE `tutors` SET country = ? WHERE id = ?");
      $update_country->execute([$country, $user_id]);
   ...
   if (!empty($city)) {
      $update_city = $conn->prepare("UPDATE `tutors` SET city = ? WHERE id = ?");
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <p>your country</p>
            <input type="text" name="country" placeholder="<?= $fetch_profile['country']; ?>" maxlength="20" class="box">
            <p>update pic</p>
            <input type="file" name="image" accept="image/*" class="box">
         </div>
         <div class="col">
            <p>your city</p>
            <input type="text" name="city" placeholder="<?= $fetch_profile['city']; ?>" maxlength="20" class="box">
            <p>old password :</p>
