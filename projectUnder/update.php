...
if(isset($_POST['submit'])){
  ...
  if(!empty($name)){
   ...
   $studentNo = filter_var($studentNo, FILTER_SANITIZE_STRING);

   if (!empty($studentNo)) {
      $update_studentNo = $conn->prepare("UPDATE `users` SET studentNo = ? WHERE id = ?");
      $update_studentNo->execute([$studentNo, $user_id]);
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <p>student number</p>
            <input type="text" name="studentNo" placeholder="<?= $fetch_profile['studentNo']; ?>" maxlength="20" class="box">
            <p>update pic</p>
            <input type="file" name="image" accept="image/*" class="box">
         </div>
         <div class="col">
         <p>year</p>
         <input type="text" name="year" placeholder="<?= $fetch_profile['year']; ?>" maxlength="20" class="box">
               <p>old password</p>
